...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { country: @history.country, shipping_address: @history.shipping_address } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { country: @history.country, shipping_address: @history.shipping_address } }
